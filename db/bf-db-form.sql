...
CREATE TABLE `city` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_city_department_idx` (`department_id`),
  CONSTRAINT `fk_city_department` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`)
...
CREATE TABLE `image` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_image_offer_idx` (`offer_id`),
  CONSTRAINT `fk_image_offer` FOREIGN KEY (`offer_id`) REFERENCES `offer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-10-28 14:02:27
